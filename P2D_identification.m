...
tsp            = 100000;
opt            = odeset('Mass', M1,'MStateDependence','weak','RelTol',1e-5,'AbsTol',...
                        1e-5,'InitialStep',1e-3,'MaxStep',5,'Events',@stopcondition);
warning('off','all');
tic
...
% In this code, 'Initime' is set up as 200 seconds. For 200s, consistent initial conditions 
% are determined, and this should be excluded for actual simulations.
